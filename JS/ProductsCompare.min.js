...
const getPriceProduct = (t) =>
    ...
    removeCompareProducts = (t) => {
        (compareProducts = compareProducts.filter((n) => n.slug !== t)),
    ...
    getHTMLCompareProducts = (t) =>
        `                            \n        <table class="table-bordered">\n                <tr>\n                    <td class="align-top">Features:</td>\n                    ${t
                ...
                (t) =>
                    `\n                        <td>\n                            <div class="content-product__item__delete text-right">\n                                <button onclick="removeCompareProducts('${
                        ...
                        window.location.href.includes('WebSite_BanGiay_T3H2')
                            ? '/WebSite_BanGiay_T3H2'
                            : ''
                    }/ProductDetaildPage.html?product=${t.slug}">${
                        t.name
            ...
            .join('')}\n                </tr>\n            </table>\n    `;
(() => {
    const t = $('.content__list');
    setTimeout(() => {
        0 === compareProducts.length
            ? (t.addClass('content__list--no-item'),
              t.html(
