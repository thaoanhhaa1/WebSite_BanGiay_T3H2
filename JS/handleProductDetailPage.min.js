...
const getPriceProduct = (o) =>
    o.discount ? (o.price * (100 - o.discount)) / 100 : o.price;
function handleProductDetailPage() {
    ...
    function c() {
        t.addEventListener('blur', () => {
            ...
            $('.form-register-product-left__tool-zoom').bind(
                'click',
                function (o) {
        ...
        $(window).resize(function () {
            ...
            return o <= 575
                ? (window.location.reload(!0),
                  c(),
                  void console.log('load mobile'))
                : o <= 991
                ? (window.location.reload(!0),
                  c(),
                  void console.log('load tablet'))
                : o >= 1200
                ? (window.location.reload(!0), c(), void console.log('load pc'))
                : void 0;
        });
}
fetch(
    ...
    .then((o) => {
        ...
        $('section').html(
            `\n            <div class="site__map">\n                <p><a href="index.html" class="site__map-home">HOME</a> <span> > </span>\n                    <a class="site-map-product-details" href="">${t.name
                ...
                .map(
                    (o) =>
                        `\n                                <span class="form-register-product-left__status_price ${o
                            .toLowerCase()
                            .split(' ')
                            .join(
                                '-',
                ...
                .map(
                    (o, t) =>
                        `\n                            <div class="form-register-product__list-item">\n                                <a class="form-register-product__list__item__link ${
                            0 === t && 'active'
                        }" href="#" data-image="IMG/${o}" data-zoom-image="IMG/${o}">\n                                    <img src="IMG/${o}" alt="anh ${
                            t + 1
                ...
                .map(
                    (o, t) =>
                        `\n                                <label for="choose-size-${
                            t + 1
                        }" class="form-register-product-right__option__size-list__box">\n                                    <input type="radio" name="product-size" value="${o}" data-product-attribute="${
                            t + 1
                        }" id="choose-size-${
                            t + 1
                ...
                .map(
                    (o, t) =>
                        `\n                                <label for="choose-color-${
                            t + 1
                        }" class="form-register-product-right__option__color-list__box">\n                                    <input type="radio" value="${o}" name="product-color" id="choose-color-${
                            t + 1
                ...
                compareProductList.hasProduct(t) && 'is-added'
